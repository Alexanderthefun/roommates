            ...
            while (runProgram)
            {
                ...
                switch (selection)
                {
                    ...
                    case ("Search for roommate"):
                        ...
                        Console.WriteLine($"{roommate.FirstName}'s rent portion is {roommate.RentPortion}. They live in {roommate.Room.Name}.");
                        Console.Write("Press any key to continue");
                        Console.ReadKey();
                        break;
                    ...
                    case ("Delete a room"):
                        ...
                        {
                            Console.WriteLine("Somebody lives here. You need to reassign them to another room first. Choose a room:");
                                foreach (Room r in roomsToDelete)
                            {
                            ...
                            roomRepo.UpdateRoomId(deleteMe, newId);
                            roomRepo.Delete(deleteMe);
                            Console.WriteLine("Room has been successfully deleted.");
                        }
                        Console.Write("Press any key to continue");
                    ...
                    case ("Update a chore"):
                        ...
                        break;
                    case ("Delete a chore"):
                        List<Chore> choreSelection = choreRepo.GetAll();
                        Console.WriteLine("Select a chore to delete.");
                        foreach (Chore c in choreSelection)
                        {
                        ...
                        Console.WriteLine("That chore is no longer someone's problem.");
                        Console.Write("Press any key to continue");
                        Console.ReadKey();
                        break;
                    case ("Exit"):
